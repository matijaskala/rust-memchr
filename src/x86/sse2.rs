...
pub unsafe fn rawmemchr(n1: u8, haystack: *const u8) -> usize {
    ...
    if let Some(i) = forward_search1(start_ptr, ptr, vn1) {
        return i;
    }
...
#[target_feature(enable = "sse2")]
pub unsafe fn rawmemchr2(n1: u8, n2: u8, haystack: *const u8) -> usize {
    let vn1 = _mm_set1_epi8(n1 as i8);
...
#[target_feature(enable = "sse2")]
pub unsafe fn rawmemchr3(n1: u8, n2: u8, n3: u8, haystack: *const u8) -> usize {
    let vn1 = _mm_set1_epi8(n1 as i8);
    let vn2 = _mm_set1_epi8(n2 as i8);
    ...
    if let Some(i) = forward_search3(start_ptr, ptr, vn1, vn2, vn3) {
        return i;
    }
